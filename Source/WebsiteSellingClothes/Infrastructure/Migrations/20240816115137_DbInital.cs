    ...
    public partial class DbInital : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    DestinationLogo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DestinationShortName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DestinationName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    PaymentDestinationParentId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaymentDestinations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PaymentDestinations_PaymentDestinations_PaymentDestinationParentId",
                        column: x => x.PaymentDestinationParentId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SercetKey = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotificationSignature = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NotificationStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NotificationResDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SignatureAlgo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SignatureDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SignatureOwn = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PaymentId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionPayload = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "DestinationLogo", "DestinationName", "DestinationShortName", "IsActive", "PaymentDestinationParentId" },
                values: new object[,]
                {
                    { "DEST001", "https://admin.softmaster.vn/_default_upload_bucket/154573132_152687123342645_1913382004205201124_n.png", "Công ty Cổ phần Giải pháp Thanh toán Việt Nam", "VNPAY", true, null },
                    { "DEST002", "https://upload.wikimedia.org/wikipedia/vi/f/fe/MoMo_Logo.png", "CÔNG TY CỔ PHẦN DỊCH VỤ DI ĐỘNG TRỰC TUYẾN", "MOMO", true, null },
                    { "DEST003", "https://cdn.haitrieu.com/wp-content/uploads/2022/10/Logo-ZaloPay-Square.png", "Công ty Cổ phần ZION", "ZALOPAY", true, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentDestinations_PaymentDestinationParentId",
                table: "PaymentDestinations",
                column: "PaymentDestinationParentId");
